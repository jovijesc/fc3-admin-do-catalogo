...
public class DefaultVideoGatewayTest {
    ...
    public void setUp() {
        ...
        paulo = castMemberGateway.create(Fixture.CastMembers.paulo());
    ...
    public void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        Assertions.assertEquals(expectedLauncYear, actualVideo.getLaunchedAt());
        ...
        Assertions.assertEquals(expectedLauncYear, Year.of(persistedVideo.getYearLaunched()));
    ...
    @Test
    public void givenAnInvalidVideo_whenCallsFindById_shouldEmpty() {
        // given
        videoGateway.create(Video.newVideo(
                Fixture.title(),
                Fixture.Videos.description(),
    ...
    @Test
    public void givenAValidCategories_whenCallFindAll_shouldReturnFilteredList() {
        // given
        mockVideos();
        ...
        Assertions.assertEquals("21.1 Implementação dos testes integrados", actualPage.items().get(0).title());
    ...
    public void givenAValidCastMember_whenCallFindAll_shouldReturnFilteredList() {
        ...
        Assertions.assertEquals("System Design na prática", actualPage.items().get(1).title());
    ...
    @ParameterizedTest
    @CsvSource({
            "0,2,2,4,21.1 Implementação dos testes integrados;Aula de Empreendedorismo",
            "1,2,2,4,Não cometa esses erros ao trabalhar com microserviços;System Design na prática",
    })
    ...
    @ParameterizedTest
    @CsvSource({
            "system,0,10,1,1,System Design na prática",
            "microserv,0,10,1,1,Não cometa esses erros ao trabalhar com microserviços",
            "empreendedorismo,0,10,1,1,Aula de Empreendedorismo",
            "21,0,10,1,1,21.1 Implementação dos testes integrados",
    })
    public void _givenAValidTerm_whenCallFindAll_shouldReturnFiltered(
    ...
    @ParameterizedTest
    @CsvSource({
            "title,asc,0,10,4,4,21.1 Implementação dos testes integrados",
            "title,desc,0,10,4,4,System Design na prática",
            "createdAt,asc,0,10,4,4,System Design na prática",
    ...
    private void mockVideos() {
        ...
        videoGateway.create(Video.newVideo(
                ...
                Set.of(lives.getId()),
                Set.of(tech.getId()),
                Set.of(wesley.getId(), paulo.getId())
        ));
        ...
        videoGateway.create(Video.newVideo(
                "21.1 Implementação dos testes integrados",
                Fixture.Videos.description(),
                Year.of(Fixture.year()),
                Fixture.duration(),
                Fixture.bool(),
