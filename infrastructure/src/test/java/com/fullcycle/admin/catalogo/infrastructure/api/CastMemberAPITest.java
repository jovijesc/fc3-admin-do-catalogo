...
public class CastMemberAPITest {
    ...
    public void givenAValidId_whenCallsGetById_shouldReturnIt() throws Exception {
        ...
        response.andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.created_at", equalTo(aMember.getCreatedAt())))
                .andExpect(jsonPath("$.updated_at", equalTo(aMember.getCreatedAt())));

        verify(getCastMemberByIdUseCase).execute(eq(expectedId));
    }

    @Test
    public void givenAnInvalidId_whenCallsGetByIdAndCastMemberDoesNotExists_shouldReturnNotFound() throws Exception {
        // given
