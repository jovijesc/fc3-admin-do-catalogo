...
public class GenreAPITest {
    ...
    @Test
    public void ginveAnInvalidName_whenCallsCreateGenre_shouldReturnNotification() throws Exception {
        // given
    ...
    @Test
    public void givenAValidId_whenCallsGeGenreById_shouldReturnGenre() throws Exception {
        // given
        final var expectedName = "Ação";
        final var expectedCategories = List.of("123", "456");
    ...
    @Test
    public void givenAnInvalidId_whenCallsGeGenreById_shouldReturnNotFound() throws Exception {
        // given
    ...
    @Test
    public void ginveAnInvalidName_whenCallsUpdateGenre_shouldReturnNotification() throws Exception {
        // given
        final String expectedName = null;
        final var expectedCategories = List.of("123", "456");
        final var expectedIsActive = true;
