...
public class CategoryAPITest {
    ...
    @Test
    public void givenAnInvalidId_whenCallsUpdateCategory_shouldReturnNotFound() throws Exception{
        // given
    ...
    @Test
    public void givenValidParams_whenTermDoesntMatchesPrePersisted_shouldReturnCategories() throws Exception {
        // given
        final var aCategory =
        ...
        final var expectedItemsCounts = 1;
        ...
        response.andExpect(status().isOk())
                        ...
                        .andExpect(jsonPath("$.items", hasSize(expectedItemsCounts)))
