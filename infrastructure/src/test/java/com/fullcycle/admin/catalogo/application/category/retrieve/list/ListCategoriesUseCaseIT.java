...
public class ListCategoriesUseCaseIT {
    ...
    public void givenAValidTerm_whenTermDoesntMatchesPrePersisted_shouldReturnEmptyPage() {
        ...
        final var expectedTerms = "j234iji reiu3209";
        ...
        Assertions.assertEquals(expectedItemsCounts, actualResult.items().size());
    ...
    public void givenAValidSortAndDirection_whenCallsListCategories_thenShouldRetunrCategories(
