...
public class ListCastMemberUseCaseIT  {
    ...
    @Test
    public void givenAValidQuery_qhenCallsListCastMembersAndIsEmpty_shouldReturn() {
        // given
        final var expectedPage = 0;
        final var expectedPerPage = 10;
    ...
    @Test
    public void givenAValidQuery_qhenCallsListCastMembersAndGatewayThrowsRandomException_shouldException() {
        // given
        final var expectedPage = 0;
        final var expectedPerPage = 10;
        final var expectedTerms = "";
