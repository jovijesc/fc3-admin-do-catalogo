...
public class VideoEncoderResultTest {
    ...
    @Test
    public void testMarshalSuccessResult() throws IOException {
        // given
        final var expectedId = IdUtils.uuid();
        final var expectedOutputBucket = "codeeducationtest";
        final var expectedStatus = "COMPLETED";
    ...
    public void testUnmarshalErrorResult() throws IOException {
        // given
        final var expectedMessage = "Result not found";
        ...
        final var json = """
                ...
                """.formatted(expectedStatus, expectedMessage,
    ...
    @Test
    public void testMarshalErrorResult() throws IOException {
        // given
        final var expectedMessage = "Result not found";
        final var expectedStatus = "ERROR";
        final var expectedResourceId = IdUtils.uuid();
