...
@E2ETest
@Testcontainers
public class CastMemeberE2ETest implements MockDsl {
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToCreateNewCastMemberWithValidValues() throws Exception {
    ...
    @Test
    public void asCatalogAdminIShouldBeAbleToSeeATreatedErrorByCreatingANewCastMemberWithInvalidValues() throws Exception {
        Assertions.assertEquals(0, castMemberRepository.count());
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToSortThroughAllMembersByNameDesc() throws Exception {
        Assertions.assertEquals(0, castMemberRepository.count());
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
