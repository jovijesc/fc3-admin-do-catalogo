...
public class UpdateVideoUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenAValidCommand_whenCallsUpdateVideoThrowsException_shouldReturnClearResources() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();

        final var expcetionErrorMessage = "An error on update video was observed";
