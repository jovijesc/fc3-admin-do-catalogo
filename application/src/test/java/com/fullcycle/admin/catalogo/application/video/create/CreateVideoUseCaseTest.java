...
public class CreateVideoUseCaseTest extends UseCaseTest {
    ...
    protected List<Object> getMocks() {
        return List.of(videoGateway, categoryGateway, genreGateway, categoryGateway, mediaResourceGateway);
    }
    ...
    public void givenAValidCommand_whenCallsCreateVideo_shouldReturnVideoId() {
        ...
        verify(videoGateway).create(argThat(actualVideo ->
                Objects.equals(expectedTitle, actualVideo.getTitle())
                        ...
                        && Objects.equals(expectedLauncYear, actualVideo.getLaunchedAt())
    ...
    public void givenAnInvalidRating_whenCallsCreateVideo_shouldReturnDomainException() {
        ...
        final var expectedOpened = Fixture.bool();
        final var expectedPublished = Fixture.bool();
        final var expectedRating = "rating invalido";
        final var expectedCategories = Set.<CategoryID>of();
        final var expectedGenres = Set.<GenreID>of();
        final var expectedMembers = Set.<CastMemberID>of();
        final Resource expectedVideo = null;
    ...
    public void givenANullLaunchYear_whenCallsCreateVideo_shouldReturnDomainException() {
        ...
        final var expectedTitle = Fixture.title();
        final var expectedDescription = Fixture.Videos.description();
        final Integer expectedLauncYear = null;
        final var expectedDuration = Fixture.duration();
        final var expectedOpened = Fixture.bool();
        final var expectedPublished = Fixture.bool();
        final var expectedRating = Fixture.Videos.rating();
    ...
    public void givenAValidCommand_whenCallsCreateVideoAndSomeCategoriesDoesNotExists_shouldReturnDomainException() {
        ...
        final var expectedTitle = Fixture.title();
        final var expectedDescription = Fixture.Videos.description();
        final var expectedLauncYear = Fixture.year();
        final var expectedDuration = Fixture.duration();
        final var expectedOpened = Fixture.bool();
        final var expectedPublished = Fixture.bool();
        final var expectedRating = Fixture.Videos.rating();
    ...
    @Test
    public void givenAValidCommand_whenCallsCreateVideoThrowsException_shouldReturnClearResources() {
        // given
        final var expcetionErrorMessage = "An error on create video was observed";
        ...
        // then
        Assertions.assertNotNull(actualException);
        Assertions.assertTrue(actualException.getMessage().startsWith(expcetionErrorMessage));
